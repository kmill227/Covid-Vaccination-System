...
class Appointment:
    ...
    def createAppointment(self): 
        ...
        args = (self.userID, self.campus, self.date, self.time, self.vaccine.getBrand())
        db.cursor.execute(sql, args)
        db.connection.commit()
        db.connection.close()

    def followUpSchedule(self):
        # if brand is Moderna or pfizer, automatically schedules a second appointment
        pass
